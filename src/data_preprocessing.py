...
if __name__ == '__main__':
    ...
    test_df = pd.DataFrame({
        ...
        'TARGET': [0, 0, 1, 0, 1],
        'AMT_INCOME_TOTAL': [100000, 200000, np.nan, 150000, 180000],
        'NAME_CONTRACT_TYPE': ['Cash loans', 'Revolving loans', 'Cash loans', np.nan, 'Cash loans'],
        'DAYS_EMPLOYED': [1000, 2000, 365243, 1500, 1800]
    })
    
    print("原始数据:")
    print(test_df)
    
    processed = preprocessor.preprocess(test_df, is_train=True)
    print("\n处理后数据:")
    print(processed)
